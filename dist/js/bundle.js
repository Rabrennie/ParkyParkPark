...
var Bomb = exports.Bomb = function Bomb(x, y) {
  ...
  this.body = new p2.Body({
    mass: 0,
    position: [x / _config2.default.zoom, y / _config2.default.zoom],
    angle: 0,
    velocity: [0, 0],
    angularVelocity: 0,
  ...
  this.body.shapes[0].collisionGroup = _config2.default.BOMB;
  this.body.shapes[0].collisionMask = _config2.default.PLAYER | _config2.default.CAR;
  ...
  _config2.default.container.addChild(this.graphics);
  this.body.onCollision = function () {
    _config2.default.world.removeBody(_this.body);
    _config2.default.container.removeChild(_this.graphics);
    _this.explosion.explode();
  };
  this.explosion = new _Explosion.Explosion([x, y], 8, 2);
};

},{"./Explosion.js":2,"./config.js":8}],2:[function(require,module,exports){
'use strict';
...
var _ScreenShake = require('./ScreenShake.js');
...
function Explosion(point, force, radius) {
  ...
  this.point = [];
  this.point[0] = point[0] / _config2.default.zoom;
  this.point[1] = point[1] / _config2.default.zoom;
  ...
  this.body.shapes[0].collisionGroup = _config2.default.EXPLOSION;
  this.body.shapes[0].collisionMask = _config2.default.PLAYER | _config2.default.CAR;
  ...
  this.explode = function () {
    _config2.default.world.addBody(_this.body);
    _config2.default.container.addChild(_this.graphics);

    (0, _ScreenShake.screenShake)();
...
},{"./ScreenShake.js":5,"./config.js":8}],3:[function(require,module,exports){
'use strict';
...
exports.getKeysDown = getKeysDown;
...
function getKeysDown() {
  var downKeys = [];
  _.forOwn(_keys, function (value, key) {
    if (value === 1) {
      downKeys.push(key);
    }
  });
...
exports.ParkingSpace = undefined;
...
var ParkingSpace = exports.ParkingSpace = (function () {
  function ParkingSpace() {
    var opts = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

    _classCallCheck(this, ParkingSpace);
    ...
    var defaults = {
      ...
      scaleX: 0.6,
      scaleY: 0.6,
      world: _config2.default.world,
      container: _config2.default.container,
      collisionGroup: _config2.default.PARKING,
      stage: _config2.default.stage,
      texture: _loader2.default.ParkingSpace.texture
    };
    ...
    this.sprite.scale.x = _config2.default.scaleFactorX * opts.scaleX / _config2.default.zoom;
    this.sprite.scale.y = _config2.default.scaleFactorY * opts.scaleY / _config2.default.zoom;
...
exports.shakeUpdate = shakeUpdate;
...
function screenShake(frames, strength) {
  shakeFrames = frames || 12;
  shakeFrames = shakeFrames / 4 * 3 + shakeFrames / 4 * _config2.default.screenShake;
...
function shakeUpdate() {
  // Screen Shake
  if (shakeFrames > 0) {
    var magnitude = shakeFrames / shakeStrength * shakeStrength * _config2.default.screenShake;
    var x = Random.integer(-magnitude, magnitude)(mt);
    var y = Random.integer(-magnitude, magnitude)(mt);

    _config2.default.stage.position.x = x;
    _config2.default.stage.position.y = y;
    shakeFrames--;
  } else {
    _config2.default.stage.position.x = 0;
    _config2.default.stage.position.y = 0;
  }
}
...
var Wall = exports.Wall = (function () {
  function Wall(x, y, w, h, angle, container, world) {
    ...
    this.wallBody = new p2.Body({
      position: [_config2.default.scaleFactorX * x / _config2.default.zoom, _config2.default.scaleFactorY * y / _config2.default.zoom],
      mass: 0,
      angle: angle
    });

    this.wallBody.onCollision = function (body, otherShape, playerHit) {
      if (playerHit) {
        (0, _ScreenShake.screenShake)(2, 1);
      }
    };
    ...
    this.boxShape = new p2.Box({ width: _config2.default.scaleFactorX * w / _config2.default.zoom, height: _config2.default.scaleFactorY * h / _config2.default.zoom });
    this.boxShape.collisionGroup = _config2.default.WALL;
    this.boxShape.collisionMask = _config2.default.PLAYER | _config2.default.CAR | _config2.default.TRUCKBACK;
...
},{"./ScreenShake.js":5,"./config.js":8}],7:[function(require,module,exports){
'use strict';
...
var world = _config2.default.world,
    renderer = _config2.default.renderer,
    stage = _config2.default.stage,
    container = _config2.default.container;
...
function init() {
  ...
  world.on('impact', function (evt) {
    ...
    if (bodyA.onCollision) {
      bodyA.onCollision(bodyB, shapeA, bodyB === _gamestate2.default.player.body);
    }
    if (bodyB.onCollision) {
      bodyB.onCollision(bodyA, shapeB, bodyA === _gamestate2.default.player.body);
    }
  });

  window.addEventListener('keydown', function (evt) {
    (0, _Input.setKey)(evt.keyCode, 1);
    onInputChange();
  });
  window.addEventListener('keyup', function (evt) {
    (0, _Input.setKey)(evt.keyCode, 0);
    onInputChange();
  });
  ...
  function onInputChange() {
    ...
    if ((0, _Input.key)('debug') && _gamestate2.default.mode !== null) {
      wasDebug = !wasDebug;
      _gamestate2.default.mode.debug(wasDebug);
    }

    if (_gamestate2.default.playing) {
      _gamestate2.default.player.onInput();
      return;
    }

    var _ref = _gamestate2.default.menus[_gamestate2.default.menus.length - 1].onInputChange(_gamestate2.default.menus) || {};

    var _playing = _ref._playing;
    var _level = _ref._level;

    if (_playing !== undefined) {
      _gamestate2.default.playing = _playing;
      _gamestate2.default.level = _level;
      _gamestate2.default.level.load();
    }

    if (_gamestate2.default.menus.length === 0) {
      _gamestate2.default.playing = true;
    }
  }
...
function loop(now) {
  (0, _ScreenShake.shakeUpdate)();

  if (_gamestate2.default.mode !== null) {
    _gamestate2.default.mode.loop(now, loop);
  } else {
    (0, _menuLoop2.default)(now, loop);
  }
}

},{"./Bomb.js":1,"./Input.js":3,"./ScreenShake.js":5,"./config.js":8,"./gamestate":15,"./menuLoop.js":18,"./menus/MainMenu.js":20}],8:[function(require,module,exports){
"use strict";
...
var Car = (function (_Entity) {
  ...
  function Car() {
    ...
    _this.body.onCollision = function (body, otherShape, playerHit) {
      ...
      if (playerHit) {
        (0, _ScreenShake.screenShake)(6, 6);
      }
    ...
    _this.boxShape = new p2.Box({ width: opts.w, height: opts.h });
    _this.boxShape.collisionGroup = opts.collisionGroup;
    _this.boxShape.collisionMask = opts.collisionMask;
    _this.body.addShape(_this.boxShape);
    // Create the vehicle
    _this.vehicle = new p2.TopDownVehicle(_this.body);
    // Add one front wheel and one back wheel - we don't actually need four :)

    _this.body.frontWheel = _this.vehicle.addWheel({
      localPosition: [0, 0.5] // front
    });

    _this.body.frontWheel.setSideFriction(200);

    // Back wheel
    _this.body.backWheel = _this.vehicle.addWheel({
      localPosition: [0, -0.5] // back
    });
    _this.body.backWheel.setSideFriction(200); // Less side friction on back wheel makes it easier to drift
    _this.vehicle.addToWorld(opts.world);

    _this.wheelSprite = [];

    for (var i = opts.wheelPositions.length - 1; i >= 0; i--) {
      _this.wheelSprite[i] = new PIXI.Sprite(opts.wheelTexture);
      _this.wheelSprite[i].scale.x = 0.016;
      _this.wheelSprite[i].scale.y = 0.016;
      _this.wheelSprite[i].anchor = new PIXI.Point(1, 0.5);
      _this.wheelSprite[i].position = opts.wheelPositions[i];
      _this.graphics.addChild(_this.wheelSprite[i]);
    }

    _this.sprite = new PIXI.Sprite(opts.texture);
    _this.graphics.addChild(_this.sprite);
    _this.sprite.width = -_this.boxShape.width;
    _this.sprite.height = -_this.boxShape.height;
    _this.sprite.position = { x: -_this.boxShape.width / 2, y: _this.boxShape.height / 2 };
    _this.sprite.scale.x = -_this.sprite.scale.x;

    // "Extra" Sprite for displaying on-hit graphics
    _this.hitSprite = new PIXI.Sprite(opts.texture === _loader2.default.OrangeTruck.texture ? _loader2.default.TruckHit.texture : _loader2.default.CarHit.texture);
    _this.graphics.addChild(_this.hitSprite);
    _this.hitSprite.width = -_this.boxShape.width;
    _this.hitSprite.height = -_this.boxShape.height;
    _this.hitSprite.position = { x: -_this.boxShape.width / 2, y: _this.boxShape.height / 2 };
    _this.hitSprite.scale.x = -_this.hitSprite.scale.x;
    _this.hitSprite.alpha = 0;
    return _this;
  }

  _createClass(Car, [{
    key: 'setSideFriction',
    value: function setSideFriction(front, back) {
    ...
    value: function onInput() {
      var maxSteer = 20000;
      var left = (0, _Input.key)('steerLeft');
      var right = (0, _Input.key)('steerRight');
...
var defaults = { texture: _loader2.default.OrangeTruck.texture,
  w: 0.7,
  h: 1.075,
  wheelPositions: [{ x: -0.24, y: 0.32 }, { x: 0.40 - 0.078, y: 0.32 }, { x: -0.30, y: 0 }, { x: 0.5 - 0.108, y: 0 }, { x: -0.30, y: -0.38 }, { x: 0.5 - 0.108, y: -0.38 }],
  mass: 5,
  collisionGroup: _config2.default.PLAYER };
...
var Truck = (function (_Car) {
  ...
  function Truck() {
    ...
    _this.boxShape.collisionMask = opts.collisionMask;
    _this.body.addShape(_this.boxShape);
    _this.boxShape.position[0] = 0;
    _this.boxShape.position[1] = 0.3;

    _this.boxShapeBack = new p2.Box({ width: opts.w * 0.9, height: (opts.h - 0.4) * 0.92 });
    _this.boxShapeBack.collisionGroup = _config2.default.TRUCKBACK;
    _this.boxShapeBack.collisionMask = opts.collisionMask;
    _this.body.addShape(_this.boxShapeBack);
    _this.boxShapeBack.position[0] = 0;
    _this.boxShapeBack.position[1] = -0.2;

    _this.body.onCollision = function (body, shape, playerHit) {
      var bodyMomentum = [body.velocity[0] * body.mass, body.velocity[1] * body.mass];
      var thisMomentum = [_this.body.velocity[0] * _this.body.mass, _this.body.velocity[1] * _this.body.mass];

      if (playerHit) {
        (0, _ScreenShake.screenShake)(6, 8);
      }

      // Explosion tigger sensitivity
      if (shape.collisionGroup === _config2.default.TRUCKBACK && _this.exploded === false && (p2.vec2.length(bodyMomentum) > 6.1 || p2.vec2.length(thisMomentum) > 6.1)) {
        _this.explosion = new _Explosion.Explosion([_this.body.position[0] * _config2.default.zoom, _this.body.position[1] * _config2.default.zoom], 8, 2);
        _this.explosion.explode();
        _this.sprite.texture = _loader2.default.RektTruck.texture;
        _this.sprite.height = -_this.sprite.height;
...
var _Car6 = require('./Car.js');

var _Car7 = _interopRequireDefault(_Car6);

var _Truck2 = require('./Truck.js');

var _Truck3 = _interopRequireDefault(_Truck2);
...
var RedCar = exports.RedCar = (function (_Car) {
  _inherits(RedCar, _Car);
  ...
  function RedCar() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(RedCar).call(this, _.defaults(_.clone(opts, true), defaults)));
  }

  return RedCar;
})(_Car7.default);

var BlueCar = exports.BlueCar = (function (_Car2) {
  _inherits(BlueCar, _Car2);
  ...
  function BlueCar() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(BlueCar).call(this, _.defaults(_.clone(opts, true), defaults)));
  }

  return BlueCar;
})(_Car7.default);

var GreenCar = exports.GreenCar = (function (_Car3) {
  _inherits(GreenCar, _Car3);
  ...
  function GreenCar() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(GreenCar).call(this, _.defaults(_.clone(opts, true), defaults)));
  }

  return GreenCar;
})(_Car7.default);

var OrangeCar = exports.OrangeCar = (function (_Car4) {
  _inherits(OrangeCar, _Car4);
  ...
  function OrangeCar() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(OrangeCar).call(this, _.defaults(_.clone(opts, true), defaults)));
  }

  return OrangeCar;
})(_Car7.default);

var RedStripeCar = exports.RedStripeCar = (function (_Car5) {
  _inherits(RedStripeCar, _Car5);
  ...
  function RedStripeCar() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(RedStripeCar).call(this, _.defaults(_.clone(opts, true), defaults)));
  }

  return RedStripeCar;
})(_Car7.default);

var OrangeTruck = exports.OrangeTruck = (function (_Truck) {
  _inherits(OrangeTruck, _Truck);
  ...
  function OrangeTruck() {
    ...
    var defaults = { texture: _loader2.default.OrangeTruck.texture };
    return _possibleConstructorReturn(this, Object.getPrototypeOf(OrangeTruck).call(this, _.defaults(_.clone(opts, true), defaults)));
  }
...
var _gamemode = require('./_gamemode');
...
var _Vehicles = require('../entities/Vehicles.js');
  ...
  _createClass(Valet, [{
    ...
    value: function loop(now, _loop) {
      if (_gamestate2.default.playing) {
        ...
        if (!_gamestate2.default.player) {
          var Car = _lodash2.default.sample(Cars);
          var spawn = _lodash2.default.sample(_gamestate2.default.level.spawnPoints);

          _gamestate2.default.player = new Car(spawn);
        }
        _gamestate2.default.player.update();

        if (p2.vec2.length(_gamestate2.default.player.body.velocity) <= 0.05 && _gamestate2.default.carsLeft > 0) {
          _gamestate2.default.player.body.backWheel.setBrakeForce(2);
          _gamestate2.default.player.boxShape.collisionGroup = _config2.default.CAR;
          _gamestate2.default.cars.push(_gamestate2.default.player);
          var Car = _lodash2.default.sample(Cars);
          var spawn = _lodash2.default.sample(_gamestate2.default.level.spawnPoints);
          _gamestate2.default.player = new Car(spawn);
          _gamestate2.default.carsLeft -= 1;
          this.carsLeft.text = 'Cars Left: ' + _gamestate2.default.carsLeft;
        }
        ...
        for (var i = _gamestate2.default.cars.length - 1; i >= 0; i--) {
          _gamestate2.default.cars[i].update();
        }
      }

      requestAnimationFrame(_loop);
      if (_gamestate2.default.playing) _config2.default.world.step(1 / 60);
      _config2.default.renderer.render(_config2.default.stage);
    }
  }, {
    key: 'debug',
    value: function debug(toggle) {
      _gamestate2.default.level.debug(toggle);
      if (_gamestate2.default.player) _gamestate2.default.player.debug(toggle);

      for (var i = 0; i < _gamestate2.default.cars.length; i++) {
        _gamestate2.default.cars[i].debug(toggle);
      }
      for (var i = 0; i < _gamestate2.default.level.parkingSpaces.length; i++) {
        _gamestate2.default.level.parkingSpaces[i].debug(toggle);
      }
    }
  }]);
...
var _ParkingSpace = require('./ParkingSpace.js');
...
var Level = (function () {
  ...
  _createClass(Level, [{
    ...
    value: function load() {
      ...
      this.sprite = new PIXI.Sprite(_loader2.default[this.texture].texture);
      this.sprite.position.x = 0 / _config2.default.zoom;
      this.sprite.position.y = -_config2.default.H / _config2.default.zoom;
      this.sprite.scale.x = _config2.default.scaleFactorX * 1 / _config2.default.zoom;
      this.sprite.scale.y = _config2.default.scaleFactorY * 1 / _config2.default.zoom;
      this.graphics.addChild(this.sprite);
      _config2.default.container.addChild(this.graphics);
    ...
    key: 'addWall',
    value: function addWall(x, y, w, h, angle) {
      var container = arguments.length <= 5 || arguments[5] === undefined ? _config2.default.container : arguments[5];
      var world = arguments.length <= 6 || arguments[6] === undefined ? _config2.default.world : arguments[6];

      this.walls.push(new _Wall.Wall(x, y, w, h, angle, container, world));
    }
  }, {
    key: 'addSpawn',
    value: function addSpawn(x, y) {
      var velX = arguments.length <= 2 || arguments[2] === undefined ? 15 : arguments[2];
      var velY = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
...
var test = exports.test = (function (_Level) {
  ...
  function test() {
    ...
    _this.addWall(583, -600, 1067, 20, 0);
    _this.addWall(583, -600, 1067, 20, 0);
    _this.addWall(101, -565, 199, 70, 0);
    _this.addWall(101, -35, 199, 70, 0);
...
function menuLoop(now, _loop) {
  var delta = now - lastTime;
  lastTime = now;

  if (_gamestate2.default.menus.length > 0) {
    _gamestate2.default.menus[_gamestate2.default.menus.length - 1].update(now, delta);
  }
...
},{"./config":8,"./gamestate":15}],19:[function(require,module,exports){
'use strict';
...
var KeyMapMenu = (function (_Menu) {
  _inherits(KeyMapMenu, _Menu);

  function KeyMapMenu() {
    _classCallCheck(this, KeyMapMenu);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(KeyMapMenu).call(this, {
      optsOffset: 200,
      optsAlign: 'left'
    }));
    ...
    _this._title = new PIXI.Text('Key Bindings', { font: '24px Arial', fill: 0xFFFFFF, align: 'center' });
    _this._title.x = renderer.width / 2 - _this._title.width / 2;
    _this._title.y = 100;
    _this.addChild(_this._title);

    _this.addKeyBind('Steer Left', 'steerLeft');
    _this.addKeyBind('Steer Right', 'steerRight');
    _this.addKeyBind('Brake', 'brake');
    _this.addKeyBind('Toggle Debug', 'debug');
  ...
  _createClass(KeyMapMenu, [{
    key: 'addKeyBind',
    value: function addKeyBind(name, binding) {
      this.addOption(name + ': ' + keycode(_Input.keymap[binding]), {
        state: {
          active: false
        },
        onInputChange: function onInputChange() {
          var downKeys = (0, _Input.getKeysDown)();
          if ((0, _Input.key)('enter')) {
            if (!this.state.active) {
              this.state.active = true;
              this.textObj.text = name + ': Press any key';
            } else {
              this.state.active = false;
              var code = parseInt(_Input.keymap[binding]);
              var _key = keycode(code);
              this.textObj.text = name + ': ' + _key;
            }
          } else if (downKeys.length > 0 && this.state.active) {
            (0, _Input.bindKey)(binding, downKeys[0]);
            var code = parseInt(_Input.keymap[binding]);
            var _key2 = keycode(code);
            this.textObj.text = name + ': ' + _key2;
            this.state.active = false;
          }
...
var _OptionsMenu = require('./OptionsMenu.js');
...
var Menu = (function (_PIXI$Container) {
  ...
  function Menu() {
    ...
    _this._options = [];
    _this.selectedOption = 0;
    _this.overrideDefaults = false;

    _this._background = new PIXI.Sprite(_loader2.default.Default.texture);
    _this._background.width = _config2.default.renderer.width;
    _this._background.height = _config2.default.renderer.height;
    _this._background.tint = 0x040404;
    _this.addChild(_this._background);

    _this._text = new PIXI.Text('MEGA ALPHA EDITION', { font: '24px Arial', fill: 0xFFFFFF, align: 'center' });
    _this._text.x = 20;
    _this._text.y = 20;
    _this.addChild(_this._text);

    _this._pointer = new PIXI.Sprite(_loader2.default.MenuArrow.texture);
    _this._pointer.width = 16;
    _this._pointer.height = 16;
    _this._pointer.visible = false;
    _this.addChild(_this._pointer);

    _this.optsOffset = opts.optsOffset || 400;
    _this.optsAlign = opts.optsAlign || 'center';
    return _this;
  }
  ...
  _createClass(Menu, [{
    ...
    value: function addOption(text) {
      ...
      if (this.optsAlign === 'left') {
        this._options[i].textObj.x = _config2.default.renderer.width / 4;
      } else {
        // i.e. 'center'
        this._options[i].textObj.x = _config2.default.renderer.width / 2 - this._options[i].textObj.width / 2;
      }
      this._options[i].textObj.y = this.optsOffset + 50 * i * _config2.default.scaleFactorY;
    ...
    key: 'onInputChange',
    value: function onInputChange(menus) {
      ...
      if (!this.overrideDefaults) {
        ...
        var _option = this._options[this.selectedOption];
        if ((0, _Input.key)('enter') && _option.callback) {
    ...
    value: function update(now, delta) {
      ...
      for (var i = 0; i < this._options.length; i++) {
        this._options[i].textObj.style = { font: 24 * _config2.default.scaleFactorX + 'px Arial', fill: 0xFFFFFF, align: 'center' };
        if (this.optsAlign === 'left') {
          this._options[i].textObj.x = _config2.default.renderer.width / 4;
        } else {
          // i.e. 'center'
...
},{"../Input.js":3,"../config.js":8,"../loader.js":17}],22:[function(require,module,exports){
'use strict';
...
var _resizeGame = require('../resizeGame.js');

var _KeyMapMenu = require('./KeyMapMenu.js');

var _KeyMapMenu2 = _interopRequireDefault(_KeyMapMenu);
...
var OptionsMenu = (function (_Menu) {
  _inherits(OptionsMenu, _Menu);

  function OptionsMenu() {
    _classCallCheck(this, OptionsMenu);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OptionsMenu).call(this, {
      optsOffset: 200,
      optsAlign: 'left'
    }));
    ...
    _this.addOption('Master Volume: ' + Math.round(_config2.default.masterVolume * 100) + '%', {
      state: {
        accumulator: 0
      },
      update: function update(now, delta) {
        ...
        if ((0, _Input.key)('left')) {
          if ((_config2.default.masterVolume -= 0.05) < 0) _config2.default.masterVolume = 0;

          if (_config2.default.masterVolume === 0) {
            this.textObj.text = 'Master Volume: 0%';
          } else {
            this.textObj.text = 'Master Volume: ' + Math.round(_config2.default.masterVolume * 100) + '%';
          }
        }
        if ((0, _Input.key)('right')) {
          if ((_config2.default.masterVolume += 0.05) > 1) _config2.default.masterVolume = 1;
          this.textObj.text = 'Master Volume: ' + Math.round(_config2.default.masterVolume * 100) + '%';
        }
      }
    });
    _this.addOption('Screen Shake: ' + Math.round(_config2.default.screenShake * 100) + '%', {
      state: {
        accumulator: 0
      },
      update: function update(now, delta) {
        ...
        if ((0, _Input.key)('left')) {
          if ((_config2.default.screenShake -= 0.05) < 0) _config2.default.screenShake = 0;

          if (_config2.default.screenShake === 0) {
            this.textObj.text = 'Screen Shake: None';
          } else {
            this.textObj.text = 'Screen Shake: ' + Math.round(_config2.default.screenShake * 100) + '%';
          }
          (0, _ScreenShake.screenShake)();
        }
        if ((0, _Input.key)('right')) {
          if ((_config2.default.screenShake += 0.05) > 2) _config2.default.screenShake = 2;

          if (_config2.default.screenShake === 2) {
      ...
      update: function update(now, delta) {
        ...
        if ((0, _Input.key)('left')) {
          if (this.state.curr === 0) {
            ...
            (0, _resizeGame.resizeGame)(this.state.sizes[this.state.curr]);
          } else {
            this.state.curr -= 1;
            (0, _resizeGame.resizeGame)(this.state.sizes[this.state.curr]);
          }
  ...
  _createClass(OptionsMenu, [{
    key: 'update',
    value: function update(now, delta) {
      _get(Object.getPrototypeOf(OptionsMenu.prototype), 'update', this).call(this, now, delta);
      this._title.x = _config2.default.renderer.width / 2 - this._title.width / 2;
      this._title.style = { font: 24 * _config2.default.scaleFactorX + 'px Arial', fill: 0xFFFFFF, align: 'center' };
    }
  }]);
...
function resizeGame(W) {
  ...
  _config2.default.W = W;
  _config2.default.H = H;
  _config2.default.scaleFactorX = W / 1067;
