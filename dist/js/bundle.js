...
var BaseTruck = (function (_BaseCar) {
  ...
  function BaseTruck() {
    ...
    _classCallCheck(this, BaseTruck);
...
var Wall = exports.Wall = (function () {
  function Wall(x, y, w, h, angle, container, world) {
    ...
    this.boxShape = new p2.Box({ width: w / _config2.default.zoom, height: h / _config2.default.zoom });
...
var Level = (function () {
  ...
  _createClass(Level, [{
    ...
    value: function load() {
      ...
      this.sprite.position.y = -600 / _config2.default.zoom;
      this.sprite.scale.x = 1 / _config2.default.zoom;
      this.sprite.scale.y = 1 / _config2.default.zoom;
      this.graphics.addChild(this.sprite);
      _config2.default.container.addChild(this.graphics);
    }
  }]);
...
var levels = {};
levels.test = new Level("Test", [new _Wall.Wall(800, -300, 20, 600, 0, _config2.default.container, _config2.default.world), new _Wall.Wall(400, 0, 800, 20, 0, _config2.default.container, _config2.default.world), new _Wall.Wall(400, -600, 800, 20, 0, _config2.default.container, _config2.default.world), new _Wall.Wall(0, -300, 20, 600, 0, _config2.default.container, _config2.default.world)], 'TestLevel');
